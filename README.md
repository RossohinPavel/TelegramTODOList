...
2) Инлайн кнопки по длинне сообщения
3) Забор и отдача тайтла задачи без булетин кнопки. Сделать по нормальному.
4) Возможность вывести список задач, которых нет в чате.
5) Добавить возможность создания задачи из аудио-сообщения.
6) Прикрутить статистику. Для начала - созданные/выполненные задачи
